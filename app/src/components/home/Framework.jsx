...
const Framework = () => {
  ...
  const framewordGridSettings = [
    ...
    {
      cardGradientBefore:
        "before:content-[''] before:bg-grad-theme-135 before:absolute before:w-[270px] before:h-[270px] before:-top-[5%] before:right-[20%] before:blur-[30px] before:rounded-full",
      cardGradientAfter:
        "after:content-[''] after:bg-grad-theme-135 after:absolute after:w-[300px] after:h-[300px] after:-bottom-[15%] after:-right-[5%] after:blur-[30px] after:rounded-full",
    },
  ];
              ...
              >
                <div
                  className={`rounded-3xl bg-jet h-full grid items-center md:grid-cols-2 ${
                    ...
                    framewordGridSettings[index].cardGradientBefore
                  } ${framewordGridSettings[index].cardGradientAfter}`}
                >
                  <div
