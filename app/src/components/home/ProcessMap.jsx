  ...
  return (
    <section className="max-w-[1200px] mx-auto py-[65px] text-white px-4">
      <div className="grid lg:grid-cols-2 gap-6 items-center">
        ...
        >
          <h3 className="lg:text-2xl md:text-xl text-lg font-montserrat font-semibold">
          ...
          <button
            type="submit"
            className="bg-risd-blue rounded-lg lg:min-h-[56px] min-h-[50px] text-nowrap md:text-base text-sm px-5 font-semibold hover:scale-105 transition-all ease-in-out duration-300"
          >
            Try it Now For Free
          </button>
        </motion.div>
